...
class node
{
	...
	int xPos;
	int yPos;
	// Total distance already traveled when reaching a node
	int level;
...
public:
	...
	// Increase the priority of travelling in a cardinal direction, instead of diagonally
	// i = Direction
...
ARecastNavMesh_GraphAStar::ARecastNavMesh_GraphAStar(const FObjectInitializer& ObjectInitializer)
